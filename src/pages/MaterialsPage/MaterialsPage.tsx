...
const fileList: File[] = [
  {
    filePath: "public/files/MaterialsPage/Конспект к занятию 1.pdf",
  ...
  {
    filePath: "public/files/MaterialsPage/Конспект к занятию 2.pdf",
  ...
  {
    filePath: "public/files/MaterialsPage/Конспект к занятию 3.pdf",
  ...
  {
    filePath: "public/files/MaterialsPage/Конспект к занятию 4.pdf",
  ...
  {
    filePath: "public/files/MaterialsPage/Конспект к занятию 5.pdf",
  ...
  {
    filePath: "public/files/MaterialsPage/Конспект к занятию 6.pdf",
  ...
  {
    filePath: "public/files/MaterialsPage/Конспект к занятию 7.pdf",
  ...
  {
    filePath: "public/files/MaterialsPage/Конспект к занятию 8.pdf",
